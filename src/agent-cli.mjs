...
} from '@narada2/carrier-runtime/provider-resolution';
import {
...
} from '@narada2/carrier-runtime/mcp-runtime';
import {
...
const CARRIER_SESSION_DIR = SESSION_DIR;
...
const OPERATION_HEARTBEAT_DIRECTIVE_ENABLED = parseBooleanEnv(process.env.NARADA_AGENT_CLI_OPERATION_HEARTBEAT_DIRECTIVE_ENABLE, false);
...
function normalizeAgentCliControlRecord(request) {
  ...
  return { input: normalizeInputEvent({
    content: message,
